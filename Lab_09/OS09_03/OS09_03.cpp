#define _CRT_SECURE_NO_WARNINGS // означает, что вы не хотите, чтобы компилятор предлагал безопасные версии библиотечных функций, например scanf_s, когда вы используете scanf
#include <Windows.h>
#include <iostream>
#include <fileapi.h>
#define FILE_PATH L"C:\\Users\\Влад\\Desktop\\Лемешевский_ОС_ИСиТ_3_2\\Lab_09\\OS09_01.txt"
...
{
	char filepath[20];
	wcstombs(filepath, fileName, 20); // широкие символы
